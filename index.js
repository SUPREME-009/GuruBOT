...
case 'Espejito' :
case 'ESPEJITO' :
const ale4 = ['eres horrible🤢','eres pasable😷','eres bonit@😲','eres tiern@☺️','eres hermos@🤭','eres feo 👺','eres l@ mejor😍','Que guapoo 🤩']
